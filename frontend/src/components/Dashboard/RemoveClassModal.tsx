...
export const RemoveClassModal: React.FC<RemoveClassModalProps> = ({
  isOpen,
  onClose,
  onRemoveClass,
  classData,
      ...
      <div className="flex min-h-full items-center justify-center p-4">
        ...
        <div className="relative bg-white dark:bg-gray-900 rounded-xl shadow-xl p-8 w-full max-w-md transform transition-all">
          ...
          <div className="text-center mb-8">
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Remove Class</h2>
            <p className="text-gray-600 dark:text-gray-400">
              Are you sure you want to remove <span className="font-semibold text-gray-900 dark:text-white">"{classData.name}"</span>?
            </p>
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">
              This action cannot be undone. All documents and data associated with this class will be permanently deleted.
            </p>
          </div>
